...
configure_build_environment()
{
    ...
    # Keep generated timestamps stable across builds.
    source_date_epoch=1779807738
    kbuild_build_timestamp=2026-05-26T15:02:18Z
...
build_linux()
{
    ...
    make -C /work/src/linux O=/work/linux-out ARCH=riscv \
        CROSS_COMPILE="${cross_compile}" -j"${build_jobs}" Image
}
